...
df <- read.csv("~/Local/Dissertation/ccombined.csv")
...
new_outputs <- list.files("~/Local/Dissertation/CampFire_2_TIFFs", full.names = TRUE)
cbuff_outputs <- list.files("~/Local/Dissertation/CBuff_tiffs", full.names = TRUE)
cb.new_outputs <- list.files("~/Local/Dissertation/CBuff_2_tiffs", full.names = TRUE)
...
df_fect_clean <- df_fect %>%
  ...
  filter(date <= as.Date("2018-11-08") | date >= ("2018-12-06"))
