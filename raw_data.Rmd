...
roi <- st_read("~/Downloads/California_Fire_Perimeters_(all)/California_Fire_Perimeters_(all).shp") # Load shapefile

f.roi <- roi %>%
  filter(FIRE_NAME == 'CAMP', 
         UNIT_ID == 'BTU')

# Correctly write full sf object, not just geometry
st_write(f.roi, 
         dsn = "~/Local/Dissertation/camp_sf", 
         layer = "camp_fire", 
